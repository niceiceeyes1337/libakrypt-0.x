...
void belt_init(ak_uint8* k, int kLen, ak_uint8* ks)
{
    ...
    case 16:
        for(i = 0; i<4; ++i)
        {
            ((ak_uint32*)ks)[i] = ((ak_uint32*)k)[i];
            ((ak_uint32*)ks)[i + 4] = ((ak_uint32*)k)[i];
        }
    ...
    case 24:
        ...
        ((ak_uint32*)ks)[6] = (((ak_uint32*)k)[0]) ^ (((ak_uint32*)k)[1]) ^ (((ak_uint32*)k)[2]);
        ((ak_uint32*)ks)[7] = (((ak_uint32*)k)[3]) ^ (((ak_uint32*)k)[4]) ^ (((ak_uint32*)k)[5]);
        break;
    //256 bits
    case 32:
...
void belt_encrypt(ak_uint8 *ks, ak_uint8 *inBlock, ak_uint8 *outBlock)
{
    ...
    ((ak_uint32 *)outBlock)[0] = b;
    ((ak_uint32 *)outBlock)[1] = d;
